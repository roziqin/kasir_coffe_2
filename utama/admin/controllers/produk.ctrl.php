...
if($_GET['ket']=='submit-produk'){
	...
	if (isset($_FILES['inputfile'])) {
		...
		$sql = "INSERT into barang(barang_nama,barang_kategori,barang_harga_beli,barang_harga_jual,barang_harga_jual_online,barang_set_stok,barang_stok,barang_batas_stok,barang_disable,barang_image)values('$nama','$kategori','$beli','$jual','$jualonline','$setstok','$stok','$batas','$disable','$logo')";
